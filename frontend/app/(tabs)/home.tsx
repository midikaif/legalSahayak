      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoContent}>
            <Text style={styles.infoTitle}>Legal Assistance at Your Fingertips</Text>
            <Text style={styles.infoText}>
              LegalSahayak helps you understand complex legal matters, analyze cases, and connect
              with lawyers.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Always document everything in writing. Keep copies of all legal documents, contracts,

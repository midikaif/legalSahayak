      ...
      <View style={styles.content}>
        <View style={styles.comingSoonCard}>
          ...
          <Text style={styles.comingSoonText}>
            We're building a verified network of lawyers across India. Soon
            you'll be able to:
          </Text>
          ...
          <View style={styles.featureList}>
            <View style={styles.featureItem}>
              ...
              <Text style={styles.featureText}>
                Search verified lawyers by specialization
              </Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
            ...
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
              <Text style={styles.featureText}>
                Read real client reviews & ratings
              </Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
              <Text style={styles.featureText}>
                Chat with lawyers before hiring
              </Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
              <Text style={styles.featureText}>
                Get matched based on your case type
              </Text>
            </View>
          </View>
